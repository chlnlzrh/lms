#!/usr/bin/env python3
"""
Count lessons per module in the Data Governance curriculum.
"""
...
def count_lessons_per_module(file_path):
    ...
    # Print results
    print("Lesson Count per Module - Data Governance Curriculum\n")
...
if __name__ == '__main__':
    file_path = Path('src/data/data_gov/Content Structure.md')
