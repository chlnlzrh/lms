#!/usr/bin/env python3
"""
Count lessons per module in the MDM curriculum.
"""
...
def count_lessons_per_module(file_path):
    ...
    # Print results
    print("Lesson Count per Module - MDM Curriculum\n")
...
if __name__ == '__main__':
    file_path = Path('src/data/mdm/content_structure_mdm-curriculum-lesson-maps.md')
