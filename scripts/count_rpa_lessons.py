#!/usr/bin/env python3
"""
Count lessons per module in the RPA curriculum.
"""
...
def count_lessons_per_module(file_path):
    ...
    print("Lesson Count per Module - RPA Curriculum\n")
...
if __name__ == '__main__':
    file_path = Path('src/data/rpa/content_structure_rpa-curriculum-lesson-maps.md')
