#!/usr/bin/env python3
"""
Count lessons per module in the Snowflake tuning curriculum.
"""
...
def count_lessons_per_module(file_path):
    ...
    print("Lesson Count per Module - Snowflake Tuning Curriculum\n")
...
if __name__ == '__main__':
    file_path = Path('src/data/snowflake_tune/content_structure_snowflake-best-practices-and-tuning—lesson-maps.md')
