"""
Generate MDM (Master Data Management) lessons using OpenAI Batch API.

This script:
1. Parses content_structure_mdm-curriculum-lesson-maps.md to extract all lessons
...
Based on generate_datagov_lessons_batch.py adapted for MDM curriculum.
"""
import os
import sys
import re
...
BATCH_INPUT_FILE = f"{BATCH_INPUT_DIR}/mdm_lessons_input.jsonl"
BATCH_RESULTS_FILE = f"{BATCH_INPUT_DIR}/mdm_lessons_results.jsonl"
...
def main():
    """Main execution flow."""
    print(f"\n{'='*80}")
    print("MDM Lessons - Batch API Generator")
    print(f"{'='*80}\n")
