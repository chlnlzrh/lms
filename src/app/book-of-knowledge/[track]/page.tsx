  ...
  return (
    <MainLayout>
      <div className="space-y-6">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  <div className={`text-2xl font-bold text-${color}-600 mb-1`}>
                    {Math.round((trackInfo.stats?.estimatedHours || 0))}h
                  </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-300 mb-3">
                  Explore {trackInfo.title.toLowerCase()} fundamentals and core concepts
                </p>
                <div className="flex items-center space-x-3">
                  <Link
                    href={`/book-of-knowledge/${trackId}/module-${modules.length > 0 ? modules[0].moduleNumber || 1 : 1}`}
              ...
              {modules.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-300">
                    Content is being developed for this knowledge area. Check back soon!
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              <div className="space-y-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-300">Knowledge Modules</div>
                </div>
                <div className="text-center">
                  <div className={`text-2xl font-bold text-${color}-600 mb-1`}>
        ...
        {/* Modules Grid - Enhanced for Knowledge Area View */}
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">
              Knowledge Modules ({modules.length})
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {modules.map((module, index) => (
              <Link
                key={module.id}
                href={`/book-of-knowledge/${trackId}/module-${module.moduleNumber}`}
